...
A collection of agent skills loaded by Cursor. Skills are organized into buckets and consumed by per-repo configuration emitted by the `setup-matt-pocock-skills` skill.
