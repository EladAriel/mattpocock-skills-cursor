...
- **[fullstack-llm-wiki-navigator](./fullstack-llm-wiki-navigator/SKILL.md)** — Navigate local framework documentation in the Fullstack LLM Wiki for FastAPI, SQLAlchemy, Next.js, pytest, and related libraries.
