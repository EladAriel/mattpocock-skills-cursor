...
Local Markdown documentation for frameworks and libraries used in fullstack repos.

## Location

Clone the wiki into the app repo root:

```bash
git clone https://github.com/EladAriel/fullstack-llm-wiki.git fullstack-llm-wiki
```

Framework docs live at `fullstack-llm-wiki/frameworks/`.

## Update

```bash
git -C fullstack-llm-wiki pull
```
