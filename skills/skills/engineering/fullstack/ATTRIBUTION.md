...
**Framework API patterns** (LangChain, LangGraph, FastAPI, SQLAlchemy, Next.js, etc.) come from the [Fullstack LLM Wiki](https://github.com/EladAriel/fullstack-llm-wiki), accessed via the `fullstack-llm-wiki-navigator` skill — not duplicated in this repo.
